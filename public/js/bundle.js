    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log(email, password); //for testing but usually not logging sensitive data to console
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            console.log("to log out"); //  if(res.data.status==='success') window.location.reload(true) //= or == or === all seem ok; === definitely ok
            ...
            } //so when logout redirect to home page
          ...
          case 8:
            ...
            (0, _alerts.showAlert)("error", "Error logging out! Please try it again.");
...
function displayMap(locations) {
  ...
  var bounds = new mapboxgl.LngLatBounds(); //bounds are areas displayed //now extended with all locations in the locations array
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend bounds to include current location
...
function _updateData() {
  _updateData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log('how come', name, email);
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](1);
            (0, _alerts.showAlert)("error", _context.t0.response.data.message); //message propert is whats defined in our server
...
function _updateSettings() {
  _updateSettings = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(data, type) {
    var url, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            _context2.prev = 8;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)("error", _context2.t0.response.data.message); //message propert is whats defined in our server
...
var stripe = Stripe('pk_test_51IYy3iIlvhZD3lNp8upep6FLeCQ2i9nW5JsOKgPBhiPkQM1LcjpLRY0aKROwzUQTU5QANAY2QjplS3zYdpLELaJR00G6aeja3b'); //OK//process.env undefined always frontend
  ...
  _bookTour = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //index.js connecting greent button with this funciton in stripe.js
            console.log("public type ", _typeof(undefined)); //undefined always
...
var loginForm = document.querySelector('.form--login'); //replacing '.form'
...
var userPwdForm = document.querySelector('.form-user-password'); //.form-user-settings

var pwdCurEl = document.getElementById('password-current');
var pwdConfirmEl = document.getElementById('password-confirm');
var savePwdBtn = document.querySelector('.btn--save-password');
var bookBtn = document.getElementById('book-tour'); //button.btn.btn--green.span-all-rows#book-tour in tourdetails.pug
//delegation

if (mapBox) {
  //render when page loading --- no addeventlistener
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); //API CALL
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    var form = new FormData(); //form.append('name',document.getElementById('name').value); //ok
    //form.append('email',document.getElementById('email').value);//ok

    form.append('name', nameEl.value);
    form.append('email', emailEl.value);
    form.append('photo', document.getElementById('photo').files[0]); //name in User doc (so key 'photo' form-data in postman & field name multer is expecting //name & id (both photo) in account.pug
...
if (userPwdForm) {
  userPwdForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              passwordCurrent = pwdCurEl.value;
              password = passwordEl.value;
              passwordConfirm = pwdConfirmEl.value;
